...
import { useGetProductRates } from "../hooks/useQueries";
    ...
    >
      <CardHeader className="pb-3">
        <div className="flex items-center gap-2">
          <CardTitle className="font-display text-lg">Current Rates</CardTitle>
          <Badge
            variant="outline"
            className="text-xs"
            style={{
              color: "oklch(0.52 0.12 55)",
              borderColor: "oklch(0.78 0.08 55)",
            }}
          >
            Reference
          </Badge>
        ...
        <CardDescription className="text-xs">
          Indicative pricing from seller — contact for confirmed quotes.
        </CardDescription>
      </CardHeader>
      <CardContent className="pt-0">
        {isLoading ? (
          <div className="space-y-2" data-ocid="order.rates.loading_state">
            {["r1", "r2", "r3", "r4"].map((k) => (
          ...
          <p
            ...
            data-ocid="order.rates.empty_state"
          >
          ...
          <div
            ...
            data-ocid="order.rates.table"
          >
            {rates.map((rate) => (
              <div
                key={rate.productType}
                className="rounded-md p-2.5"
                style={{ background: "oklch(0.97 0.02 55)" }}
              >
                <p className="text-xs font-semibold text-foreground truncate">
                  {PRODUCT_LABELS[rate.productType] ?? rate.productType}
                </p>
                <p
